export const NOTE_COLORS = [
    ...
    },
    {
        id: 'peach',
        label: 'Peach',
        className: 'bg-orange-100 dark:bg-orange-950',
    },
    {
        id: 'sand',
        label: 'Sand',
    ...
    { id: 'sage', label: 'Sage', className: 'bg-lime-100 dark:bg-lime-950' },
    { id: 'fog', label: 'Fog', className: 'bg-cyan-100 dark:bg-cyan-950' },
    { id: 'storm', label: 'Storm', className: 'bg-sky-100 dark:bg-sky-950' },
    {
        id: 'dusk',
        label: 'Dusk',
    ...
    },
    {
        id: 'blossom',
        label: 'Blossom',
        className: 'bg-fuchsia-100 dark:bg-fuchsia-950',
    },
    {
        id: 'clay',
        label: 'Clay',
...
export function noteColorClassName(color: NoteColorId): string {
    return (
        NOTE_COLORS.find((entry) => entry.id === color)?.className ??
