export const NOTE_COLORS = [
    { id: 'default', label: 'Default', className: 'bg-card' },
    {
        id: 'coral',
        label: 'Coral',
        className: 'bg-rose-100 dark:bg-rose-950/50',
    },
    {
        id: 'peach',
        label: 'Peach',
        className: 'bg-orange-100 dark:bg-orange-950/50',
    },
    {
        id: 'sand',
        label: 'Sand',
    ...
    { id: 'storm', label: 'Storm', className: 'bg-sky-100 dark:bg-sky-950/50' },
    {
        id: 'dusk',
        label: 'Dusk',
        className: 'bg-indigo-100 dark:bg-indigo-950/50',
    },
    {
        id: 'blossom',
        label: 'Blossom',
        className: 'bg-fuchsia-100 dark:bg-fuchsia-950/50',
    },
    {
        id: 'clay',
        label: 'Clay',
        className: 'bg-stone-200 dark:bg-stone-800/50',
    },
] as const;
